...
const Premium = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-8">
      ...
      <div className="relative mb-12 overflow-hidden bg-gradient-to-r from-klinkara-primary/10 to-klinkara-accent/10 p-6 rounded-none border border-klinkara-secondary">
        <div className="relative z-10">
          ...
          <Link 
            to="/shop" 
            className="inline-block bg-klinkara-primary text-white px-6 py-2 hover:bg-klinkara-accent transition-colors"
          >
            Explore More
          </Link>
        </div>
