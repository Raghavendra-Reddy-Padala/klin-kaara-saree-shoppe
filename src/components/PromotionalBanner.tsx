...
const PromotionalBanner = ({ onClose }: PromotionalBannerProps) => {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50 backdrop-blur-sm animate-fade-in">
      <div className="bg-white border border-gray-200 rounded-lg w-full max-w-md p-6 relative animate-scale-in shadow-lg">
        <button 
          onClick={onClose}
        ...
        <div className="text-center">
          ...
          <a 
            href="/premium" 
            className="block w-full bg-klinkara-primary text-white py-2 px-4 rounded-md hover:bg-klinkara-accent transition-colors shadow-sm hover:shadow-md"
            onClick={(e) => {
              e.preventDefault();
              onClose();
